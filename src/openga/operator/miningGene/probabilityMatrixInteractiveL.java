 ...
 * @version 1.0
 */
public class probabilityMatrixInteractiveL extends geneStatistics {

    public probabilityMatrixInteractiveL() {
    }
    ...
    public void setData(populationI originalPop, populationI duplicatedPopulation, double container[][], double inter[][]) {
...
//        System.exit(0);
    ...
    public void squareProbabilityMatrix1() {
    ...
    public void squareProbabilityMatrix2() {
        openga.util.algorithm.arrayMultiple arrayMultiple1 = new openga.util.algorithm.arrayMultiple();
        MarkovInter = arrayMultiple1.calcArray(inter, inter);
        //p1.printMatrix("sqaured container", MarkovContainer);
    }
    ...
    public void assignJobs(double matrix[][], double interp[][]) {
        ...
        if (applyEvaporation) {
            squareProbabilityMatrix1();
            temporaryContainer = dumpArray(MarkovContainer);
            squareProbabilityMatrix2();
            interp = dumpArray(MarkovInter);
        ...
        for (int i = 0; i < numCopied; i++) {  //start numCopied duplicatedPopulation.getPopulationSize()
            global_index = i;
            //System.out.print(applyEvaporation);
            //System.exit(0);
...
//            p1.printMatrix(""+i, duplicatedPopulation.getSingleChromosome(i).getSolution());
    ...
    public void generateChromosome(double temp[][], double _inter[][], chromosome solution) {
        //strategy
        double temporaryContainer[][];
        int prejobIndex = -1;
        int jobIndex = 0;
        ...
        temporaryContainer = dumpArray(temp);
