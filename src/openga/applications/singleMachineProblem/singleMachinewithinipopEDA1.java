...
public class singleMachinewithinipopEDA1 extends singleMachineEDA {
  public singleMachinewithinipopEDA1() {
  }
  cloneI clone1;
  EDAMainI GaMain;
  ...
  public void startMain(){
    ...
    writeFile("singleMachineEDA_SKS_20081016", implementResult);
  ...
  public static void main(String[] args) {
    System.out.println("singleMachineEDA_SKS_20081016");
    //openga.applications.data.singleMachine singleMachineData = new openga.applications.data.singleMachine();
    int jobSets[] = new int[]{90};//20, 30, 40, 50, 60, 90, 100, 200//20, 40, 60, 80
    int counter = 0;
