...
public class singleMachineDP extends singleMachine{
    public singleMachineDP() {
    }
    ...
    public MainI GaMain;
    public int totalSolnsToExamine = 75000;
    cloneI clone1;
    /**
    ...
    public void startMain(){
        ...
        writeFile("singleMachineGA_SKS_20081230_XXX", implementationResult);
    ...
    public static void main(String[] args) {
        singleMachineDP singleMachine1 = new singleMachineDP();
