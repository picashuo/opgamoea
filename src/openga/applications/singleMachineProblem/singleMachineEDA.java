...
public class singleMachineEDA extends singleMachine {
  public singleMachineEDA() {
  }
  ...
  public void startMain(){
    ...
    writeFile("singleMachineEDA_SKS_20080330", implementResult);
  ...
  public static void main(String[] args) {
    ...
    int jobSets[] = new int[]{60, 90};//20, 30, 40, 50, 60, 90, 100, 200//20, 40, 60, 80
    int counter = 0;
              ...
              for (int n = 0; n < numberOfMutationTournament.length; n++) {
                for(int p = 0 ; p < startingGenDividen.length ; p++){
                    ...
                    for(int i = 0 ; i < repeatExperiments ; i ++ ){
                      ...
                      singleMachineEDA singleMachine1 = new singleMachineEDA();
